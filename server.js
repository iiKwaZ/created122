...
const youtube = new YouTube("AIzaSyBRunLUbjxelj3kcvfiiIznfK6SmXkkm68"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyBRunLUbjxelj3kcvfiiIznfK6SmXkkm68"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("ready", () => {
  ...
  client.user.setActivity(`صيانة SCO & KwaZ | ${prefix}help`, { type: "PLAYING" });
});
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "new")) {
    const reason = message.content
      ...
      .slice(1)
      .join(" ");
    if (!message.guild.roles.exists(gg => gg.name === "Ticket Support"))
      return message.channel.send(`لازم تسوي رتبة اسمها \`Ticket Support\`.`);
    ...
    message.guild
      ...
      .then(c => {
        let role = message.guild.roles.find(gg => gg.name === "Ticket Support");
        ...
        message.channel.send(
          `:white_check_mark: تم فتح التكت الخاص بك, #${c.name}.`
        );
        const embed = new Discord.RichEmbed()
          .setColor(0xcf40fa)
          .addField(
            `Hey ${message.author.username}!`,
            `اشرح للادارة سبب فتح التكت وباذن الله بيردون عليك قريبا`
          )
          .setTimestamp();
        c.send({
          embed: embed
...
.setTitle("HELP Menue").setFooter(message.author.username,message.author.avatarURL)
.setColor("RANDOM")
.setDescription(`
HELP => الاوامر العامة => 🌎
 
HELP => الاوامر الادارية => 👑
 
HELP => اوامر الاغاني => 🎶
 
HELP => اوامر الالعاب => 🎮
 
HELP => اوامر القيف اوي => 🎉
`)
message.channel.send(help).then(async msg => {
const general = msg.createReactionCollector(
(reaction, user) =>
 reaction.emoji.name == "🌎" && user.id == message.author.id,
{ time: 864000 }
);
 
const admin = msg.createReactionCollector(
(reaction, user) =>
 reaction.emoji.name == "👑" && user.id == message.author.id,
{ time: 864000 }
);
...
const games = msg.createReactionCollector(
(reaction, user) =>
 reaction.emoji.name == "🎮" && user.id == message.author.id,
{ time: 864000 }
);
...
const Giveaway = msg.createReactionCollector(
(reaction, user) =>
 reaction.emoji.name == "🎉" && user.id == message.author.id,
{ time: 864000 }
);
...
general.on("collect", async r => {
await r.remove(message.author);
let generals = new Discord.RichEmbed()
.setColor("BLACK")
.setTitle(`**الاوامر العامة🌎**`).setDescription(`
**__الاوامر العامة__** ✽
...
.setColor("BLACK")
.setTitle(`**الاوامر الادارية 👑**`).setDescription(`
...
await r.remove(message.author);
let musics = new Discord.RichEmbed()
.setColor("BLACK")
.setTitle(`**اوامر الاغاني 🎶**`).setDescription(`
**__أوامر الموسيقى__** ✽  
...
msg.edit(musics);
games.on("collect", async r => {
await r.remove(message.author);
let games = new Discord.RichEmbed()
.setColor("BLACK")
.setTitle(`**اوامر الالعاب 🎮**`).setDescription(`
** جاري العمل عليها **
`);
msg.edit(games);
Giveaway.on("collect", async r => {
await r.remove(message.author);
let Giveaways = new Discord.RichEmbed()
.setColor("BLACK")
.setTitle(`**اوامر القيف اوي 🎉**`).setDescription(`
** جاري العمل عليها **
${prefix}
`);
msg.edit(Giveaways);
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owners** :  ", `** » <@!520945313612169236>,<@!352914701815906304>**`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .addField("**Bot Support** :  ", `** » <@!501006345902882817>* `, true)
      .setImage("")
  ...
  switch (args[0].toLocaleLowerCase()) {
    case "مسح":
      ...
      if (message.member.hasPermission(0x2000)) {
        ...
        var manage = new Discord.RichEmbed()
          .setDescription(" MANAGE_MESSAGES ليس لديك هذه الصلاحية:(")
          .setColor("RANDOM");
        message.channel.sendEmbed(manage);
        return;
      }
...
**\`${prefix}role\` : لاعطاء شخص رتبة**
**\`${prefix}role all\` : لاعطاء االجميع رتبة معينة**
**\`${prefix}rename\` : لتغيير اسم الروم** 
...
**__الاوامر الــمــعــربــة__** ✽  

✽**__ تحت الانشاء__** ✽


__ رابط الدعم الفني الخاص بالبوت __
** https://discord.gg/SEJMkB5 **
...
**__الاوامر الــمــعــربــة__** ✽  
**\**{prefix}الترحيب <channel name>**\ : لتحديد روم الولكم **

**\**{prefix}رسالة الترحيب**\ : لتحديد رسالة الترحيب **

**\** قفل= : لقفل الشات ** \**

**\**{prefix}فتح**\ : لفتح الشات **

**\ **وسوف تضاف المزيد من الاوامر المعربة** **
...
client.on("message", async message => {
  ...
  if (message.content.startsWith(prefix + "giveaway")) {
     return message.reply('** https://discord.gg/eCfDG98  القيف اوي عليه صيانة حاليا يرجى الدخول للسيرفر الخاص بالبوت **'); 
/* return message.channel.send('** https://discord.gg/eCfDG98  القيف اوي عليه صيانة حاليا يرجى الدخول للسيرفر الخاص بالبوت **'); */
...
client.on("message", message => {
  if (message.content === "سكوفيلد") {
    message.channel.send("**لبيه <a:jewrly:695157630842306600>**");
    message.channel.sendFile("");
  }
});
        ...
        message.channel
          ...
          .then(collected => {
            ...
            msg.edit("**تم الاعداد بنجاح**").then(msg => {
              let embed = new Discord.RichEmbed()
                .setTitle("**تم اعداد الترحيب بنجاح**")
...
client.on("message", async message => {
  ...
  let room = message.content.split(" ").slice(1);
  let findroom = message.guild.channels.find(r => r.name == room);
  if (message.content.startsWith(prefix + "الترحيب")) {
    if (!welcome[message.guild.id]) {
      if (!message.channel.guild)
        return message.reply("**هذا الأمر فقط للسيرفرات**");
      if (!message.member.hasPermission("MANAGE_GUILD"))
        return message.channel.send(
          "**ليس لديك صلاحية** `MANAGE_GUILD`"
        );
      if (!room) return message.channel.send("Please Type The Channel Name");
      if (!findroom) return message.channel.send("Cant Find This Channel");
      let embed = new Discord.RichEmbed()
...
client.on("message", async message => {
  let messageArray = message.content.split(" ");
  if (message.content.startsWith(prefix + "رسالة الترحيب")) {
    if (!welcome[message.guild.id] || !welcome[message.guild.id].onoff == "On")
      return message.channel.send(
        `**please type \`${prefix}setWelcomer\` first **`
      );
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "تقديم")) {
    ...
    if (!channel)
      return message.reply(
        "**لانشاء روم التقديمات ${prefix}من فضلك اكتب الامر تقديم**"
      );
    if (channel) {
...
client.on("message", light => {
  if (light.content.toLowerCase().startsWith("=rename")) {
    let perm = light.guild
      .member(client.user)
      .hasPermissions("MANAGE_CHANNELS");
    let permm = light.guild
      .member(light.author)
      .hasPermissions("MANAGE_CHANNELS");
    if (!permm) return;
    if (!perm) return light.channel.send("ليس لدي صلاحيات الرجاء اعطاء البوت صلاحيات");
    let args = light.content.split(" ");
    if (!args[1]) return light.channel.send("** الرجاء كتابة اسم الشات الجديد بعد الامر **");
    light.channel.setName(`${args[1]}`);
    light.channel.send(
      "** تم تغيير اسم الشات الى **" + `'**${args[1]}**'` + ":white_check_mark:"
    );
  }
});


//كود عدد الاعضاء الي في السيرفر 
client.on("message", async message => {
  if (message.content.startsWith(prefix + "setmember")) {
    ...
    message.guild
      ...
      .then(c => {
        ...
        setInterval(() => {
          c.setName(`عددنا  [${message.guild.members.size}]`);
        }, 1000);
      });
  }
});
...
client.on("message", async message => {
if (message.content.split(" ")[0] == prefix + "كورونا")
...
/*
client.login(process.env.TOKEN);; //بين التخصيص التوكن
...
client.on("ready", function() {
  ...
  var setGame = [
    "=help",
    "افضل بوت سيستم عربي",
    "اغلب اوامر البوت معربه",
    "وش تنتظر حياك",
    "https://discord.com/invite/2hbJSyb",
    ":dove::black_heart:"
  ];
  var i = -1;
  var j = 0;
  setInterval(function() {
    ...
    if (i == setGame.length - 3) {
      j = -1;
    }
    i = i + j;
    client.user.setGame(setGame[i], "http://www.twitch.tv/iiKwaZ");
  }, ms);
  console.log("==================================");
  console.log("1");
  console.log("2");
...
client.on("message", message => {
  if (message.content.startsWith("=bans")) {
    message.guild
      .fetchBans()
      .then(bans =>
        message.channel.send(`${bans.size} **عدد المبندين** `)
      )
      .catch(console.error);
  }
});
